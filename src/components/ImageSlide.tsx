				...
				{images.map((image, index) => (
					<SwiperSlide key={index} className="rounded-lg">
						<Card
								radius="md"
								isFooterBlurred
								className={image.desc != "0" ? "bg-black/10 h-[15em] xl:h-[50em] flex items-center object-fill" : "bg-black h-[15em] xl:h-[50em] flex items-center object-fill"}
							>
								<Image
									src={image.src}
									alt="asd"
									width={1500}
									className="mx-auto h-[15em] xl:h-[50em] object-cover"
									radius="md"
								></Image>
								{image.desc != "0" && (
